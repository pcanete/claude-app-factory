...
3b. Declare `capabilities` on the roles that may manage users, read the audit log, and review rules. Leaving them undeclared silently grants administration to any role with full entity permissions.
